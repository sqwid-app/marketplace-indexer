module.exports = class Data1688990216132 {
    name = 'Data1688990216132'

    async up(db) {
        await db.query(`CREATE TABLE "bid" ("id" character varying NOT NULL, "bidder" text NOT NULL, "value" numeric NOT NULL, "timestamp" numeric NOT NULL, "position_id" character varying, CONSTRAINT "PK_ed405dda320051aca2dcb1a50bb" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "raffle_entry" ("id" character varying NOT NULL, "user" text NOT NULL, "value" numeric NOT NULL, "timestamp" numeric NOT NULL, "position_id" character varying, CONSTRAINT "PK_b44663d6fb5a10b340e3a2fb027" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "loan_funded" ("id" character varying NOT NULL, "funder" text NOT NULL, "timestamp" numeric NOT NULL, "position_id" character varying, CONSTRAINT "PK_2ecce02aa88ff3b85d9429892b5" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "sale" ("id" character varying NOT NULL, "seller" text NOT NULL, "buyer" text NOT NULL, "price" numeric NOT NULL, "amount" integer NOT NULL, "timestamp" numeric NOT NULL, "item_id" character varying, CONSTRAINT "PK_d03891c457cbcd22974732b5de2" PRIMARY KEY ("id"))`)
